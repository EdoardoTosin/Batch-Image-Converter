...
To run the script the following modules are required (listed inside [`requirements.txt`](https://raw.githubusercontent.com/EdoardoTosin/Batch-Image-Converter/main/requirements.txt)):
```
Pillow
